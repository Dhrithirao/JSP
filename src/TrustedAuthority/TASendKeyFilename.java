 ...
 */
@WebServlet("/TASendKeyFilename")
public class TASendKeyFilename extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TASendKeyFilename() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result=ui.TASendKey2(fb);
		
		if(result==1)
		{
			JFrame f;  
			 f=new JFrame();  
			    JOptionPane.showMessageDialog(f,"Semantic-based Compound Keyword Search (SCKS) Achives FileName Based Search FileKey Sent By TA","Alert",JOptionPane.WARNING_MESSAGE);     
