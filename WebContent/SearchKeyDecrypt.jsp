...
<br/><br/><br/><br/><br/><br/>
 ...
 System.out.println("content......="+searchkey);    %>
     <center>    
            ...
            <tr style="color: red "><td>SearchKey</td><td>File Name</td><td>File Key</td><td>Download & Decrypt</td></tr>
          <%
		...
		int total=0;
				...
				{
				String q="select uname,searchkey,filename,seckey from tasendkeydetails where searchkey like'"+keyword[i]+"%'";
				...
				{					
					String q1="insert into keyworddecrypt values(?,?,?,?)";
