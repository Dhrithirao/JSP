...
<center>
          <a href="TrustedAuthorityHome.jsp"><span>Home</span></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     ...
     <br/>  <br/>
    <center><p> <h1><span> Users Information </span></h1> </p></center>
		...
		int total=0;
				...
				<td><%=key%></td>
					<td><%=resultSet.getString(2) %></td>
						...
						<td><a href="activate.jsp?key=<%=key%>"><%=resultSet.getString(9) %></a></td>
