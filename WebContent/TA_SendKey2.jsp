...
<!-- <img src="images/tc11.png" alt="" /> --><br/><br/><br/><br/><br/><br/><br/>
 ...
 <h4>  <a href="CloudServerHome.jsp"><span>Back</span></a>&nbsp;&nbsp;&nbsp;&nbsp; <a href="Home.jsp"><span>Logout</span></a><br/>  </h4>
    ...
    <center><p> <h1><span style="font-family: Times New Roman">TA File Name Based Send Key Info </span></h1> </p></center>

            <table style="width: 50%" border="1" align="center">
            <tr style="color: red "><td>User Name</td><td>Search Key</td><td>File Name</td><td>Security Key</td></tr>
            				
            				<%	int total=0;            			
				
				String q="select * from tasendkeyfilename";
