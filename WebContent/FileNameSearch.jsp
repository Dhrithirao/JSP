...
<!-- <img src="images/tc11.png" alt="" /> --><br/><br/><br/><br/><br/><br/>
 ...
 //System.out.println("servername......="+server);    %>
       ...
       <center>     <form action="search2.jsp" method="post">
            <br/><br/> 
          <b> <h1> Search File Name : </h1><input type="text" name="filename" placeholder="Enter Your File Name Here..." style="width:400px; height:30px;"/></b>
           <br></br>
           <center>
