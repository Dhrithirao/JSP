...
<%
 System.out.println("content......="+searchkey);    %>
     <center>    
             <b>
            <strong>
		...
		int total=0;
				...
				String[] keyword=searchkey.split(" ");
				
				for(int i=0;i<=keyword.length-1;i++)
				{
				String q="select searchkey,filename,type,size,path,seckey,content from files where searchkey like'"+keyword[i]+"%'";
				 System.out.println("content place 1......="+searchkey); 
				ps=Connections.con().prepareStatement(q);
				resultSet=ps.executeQuery();
				
				while(resultSet.next())
				{					
					String q1="insert into searchkeywords values(?,?,?,?)";
					...
					System.out.println("content place 3......="+searchkey);
				...
				<td><a href="SearchKeyDecrypt.jsp?searchkey=<%=searchkey%>" /><input type="submit" value="Decrypt" /></td>
