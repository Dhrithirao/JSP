...
<!-- <img src="images/tc11.png" alt="" /> --><br/><br/><br/><br/><br/><br/><br/>
 ...
 <h4>  <a href="TrustedAuthorityHome.jsp"><span>Back</span></a>&nbsp;&nbsp;&nbsp;&nbsp; <a href="Home.jsp"><span>Logout</span></a><br/>  </h4>
    ...
    <center><p> <h1><span>User Search Info </span></h1> </p></center>
            ...
            <tr style="color: red "><td>User Name</td><td>File Content</td><td>File Name</td><td>Security Key</td><td>Send Key To User</td><!-- <td>Ignore Key To User</td> --></tr>
				...
				<td><form action="TASendKeyContent?uname=<%=resultSet.getString(1) %>&&content=<%=resultSet.getString(2) %>&&filename=<%=resultSet.getString(3) %>&&key=<%=resultSet.getString(4) %>" method="post"><input type="submit" value="Send Key to User"/></form></td>
